...
export default function WelcomeMassage() {
  ...
  useEffect(() => {
    ...
    // انیمیشن اولیه حرکت از بالا به پایین
    anime({
      targets: ".drag",
      translateY: [
    ...
    // انیمیشن دوم حرکت از پایین به بالا
    anime({
      targets: ".drga2",
      translateY: [
        { value: "50vh", duration: 0 },
                          ...
                          complete: () => {
                            ...
                            if (customShape3) {
                              ...
                              anime({
                                ...
                                easing: "easeOutQuad",
                                complete: () => {
                                  // حرکت custom-shape به راست و custom-shape3 به چپ
                                  anime({
                                    targets: ".custom-shape",
                                    translateX: "150px",
                                    duration: 500,
                                    ...
                                    complete: () => {
                                      anime({
                                        targets: ".custom-shape",
                                        translateX: "-80px", // افزایش فاصله بیشتر
                                        duration: 800,
                                        delay: 300,
                                        easing: "easeOutQuad",
                                      });
                                  ...
                                  anime({
                                    targets: ".custom-shape3",
                                    translateX: "150px", // حرکت به سمت راست
                                    duration: 500,
                                    easing: "easeOutQuad",
                                    complete: () => {
                                      anime({
                                        targets: ".custom-shape3",
                                        translateX: "80px", // افزایش فاصله بیشتر به سمت راست
                                        duration: 800,
                                        delay: 300,
                                        easing: "easeOutQuad",
                                      });
  ...
  return (
    <div className="bg-slate-950 w-full h-screen">
      <div className="z-1 translate-x-[6%] translate-y-[6%]  px-8 bg-slate-800 w-[90%] h-[600px] rounded-[30px] BackGround relative z-40 overflow-hidden">
        ...
        <div className="bg-slate-800 drag w-full h-[400px]"></div>
        <div
          ref={drag2Ref}
